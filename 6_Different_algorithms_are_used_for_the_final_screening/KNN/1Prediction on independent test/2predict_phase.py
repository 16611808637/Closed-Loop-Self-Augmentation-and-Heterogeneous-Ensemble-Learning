...
# 模型文件根路径
BASE_PATH = r"D:\Papers_related_materials\second_paper\Calculation_result_after_optimization1\Single_model\combination_training_KNN"
# 各模型路径
...
CLASS_WEIGHTS = {
    "BCC":      [0, 0, 0.52, 0, 0.48],
    "BCC+FCC":  [0, 0, 0.51, 0, 0.49],
    "IM":       [0, 0, 0.34, 0.33, 0.33],
    "FCC":      [0.25, 0.25, 0.25, 0, 0.25]
}
