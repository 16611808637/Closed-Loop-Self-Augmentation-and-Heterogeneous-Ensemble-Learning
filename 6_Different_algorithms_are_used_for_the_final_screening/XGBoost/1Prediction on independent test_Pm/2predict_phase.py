...
# 模型文件根路径
BASE_PATH = r"D:\Papers_related_materials\second_paper\Calculation_result_after_optimization1\Single_model\combination_training_XGBoost"
# 各模型路径
